...
import 'package:BetterNotes/subjects/PEDUC2/Eped_card.dart';
import 'package:BetterNotes/subjects/PEDUC2/admin_Aped.dart';
import 'package:BetterNotes/subjects/PEDUC2/admin_Eped_editor.dart';
import 'package:BetterNotes/subjects/PEDUC2/admin_Eped_reader.dart';
...
class EPEDAdminCALScreen extends StatefulWidget {
  final Color backgroundColor;
  const EPEDAdminCALScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _EPEDAdminCALScreenState createState() =>
      _EPEDAdminCALScreenState(backgroundColor: AppStyle.mainColor);
}

class _EPEDAdminCALScreenState extends State<EPEDAdminCALScreen> {
  final Color backgroundColor;
  ...
  _EPEDAdminCALScreenState({required this.backgroundColor});
              ...
              child: StreamBuilder<QuerySnapshot>(
                stream: _searchController.text.isEmpty
                    ? FirebaseFirestore.instance
                        .collection('EPEDnotes')
                        .snapshots()
                    : FirebaseFirestore.instance
                        .collection('EPEDnotes')
                        .where('EPEDnote_title',
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const EPEDAdminEditorScreen()));
        },
