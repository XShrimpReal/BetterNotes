...
import 'package:BetterNotes/subjects/PEDUC2/Qped_card.dart';
import 'package:BetterNotes/subjects/PEDUC2/admin_Aped.dart';
import 'package:BetterNotes/subjects/PEDUC2/admin_Eped.dart';
import 'package:BetterNotes/subjects/PEDUC2/admin_Qped_editor.dart';
import 'package:BetterNotes/subjects/PEDUC2/admin_Qped_reader.dart';
...
class QPEDAdminCALScreen extends StatefulWidget {
  final Color backgroundColor;
  const QPEDAdminCALScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _QPEDAdminCALScreenState createState() =>
      _QPEDAdminCALScreenState(backgroundColor: AppStyle.mainColor);
}

class _QPEDAdminCALScreenState extends State<QPEDAdminCALScreen> {
  final Color backgroundColor;
  ...
  _QPEDAdminCALScreenState({required this.backgroundColor});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const QPEDAdminEditorScreen()));
        },
