...
import 'package:BetterNotes/subjects/PEDUC2/admin_Aped_editor.dart';
import 'package:BetterNotes/subjects/PEDUC2/admin_Aped_reader.dart';
...
class AdminPEDScreen extends StatefulWidget {
  final Color backgroundColor;
  const AdminPEDScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _AdminPEDScreenState createState() =>
      _AdminPEDScreenState(backgroundColor: AppStyle.mainColor);
}

class _AdminPEDScreenState extends State<AdminPEDScreen> {
  final Color backgroundColor;
  ...
  _AdminPEDScreenState({required this.backgroundColor});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const APEDAdminEditorScreen()));
        },
