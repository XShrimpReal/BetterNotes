...
import 'package:BetterNotes/subjects/PEDUC2/guest_Qped_reader.dart';
...
class QPEDGuestScreen extends StatefulWidget {
  final Color backgroundColor;
  const QPEDGuestScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _QPEDGuestScreenState createState() =>
      _QPEDGuestScreenState(backgroundColor: AppStyle.mainColor);
}

class _QPEDGuestScreenState extends State<QPEDGuestScreen> {
  final Color backgroundColor;
  ...
  _QPEDGuestScreenState({required this.backgroundColor});
