...
import 'package:BetterNotes/subjects/PEDUC2/guest_Eped_reader.dart';
...
class EPEDGuestScreen extends StatefulWidget {
  final Color backgroundColor;
  const EPEDGuestScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _EPEDGuestScreenState createState() =>
      _EPEDGuestScreenState(backgroundColor: AppStyle.mainColor);
}

class _EPEDGuestScreenState extends State<EPEDGuestScreen> {
  final Color backgroundColor;
  ...
  _EPEDGuestScreenState({required this.backgroundColor});
