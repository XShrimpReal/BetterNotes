...
class EPEDAdminReaderScreen extends StatefulWidget {
  EPEDAdminReaderScreen(this.doc, {Key? key}) : super(key: key);
  QueryDocumentSnapshot doc;

  @override
  _EPEDAdminReaderScreenState createState() => _EPEDAdminReaderScreenState();
}
...
class _EPEDAdminReaderScreenState extends State<EPEDAdminReaderScreen> {
