...
class QPEDAdminReaderScreen extends StatefulWidget {
  QPEDAdminReaderScreen(this.doc, {Key? key}) : super(key: key);
  QueryDocumentSnapshot doc;

  @override
  _QPEDAdminReaderScreenState createState() => _QPEDAdminReaderScreenState();
}
...
class _QPEDAdminReaderScreenState extends State<QPEDAdminReaderScreen> {
