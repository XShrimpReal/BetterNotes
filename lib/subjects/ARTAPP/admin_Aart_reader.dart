...
class AARTAdminReaderScreen extends StatefulWidget {
  AARTAdminReaderScreen(this.doc, {Key? key}) : super(key: key);
  QueryDocumentSnapshot doc;

  @override
  _AARTAdminReaderScreenState createState() => _AARTAdminReaderScreenState();
}
...
class _AARTAdminReaderScreenState extends State<AARTAdminReaderScreen> {
