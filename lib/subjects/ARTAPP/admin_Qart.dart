...
import 'package:BetterNotes/subjects/ARTAPP/Qart_card.dart';
import 'package:BetterNotes/subjects/ARTAPP/admin_Aart.dart';
import 'package:BetterNotes/subjects/ARTAPP/admin_Eart.dart';
import 'package:BetterNotes/subjects/ARTAPP/admin_Qart_editor.dart';
import 'package:BetterNotes/subjects/ARTAPP/admin_Qart_reader.dart';
...
class QARTAdminCALScreen extends StatefulWidget {
  final Color backgroundColor;
  const QARTAdminCALScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _QARTAdminCALScreenState createState() =>
      _QARTAdminCALScreenState(backgroundColor: AppStyle.mainColor);
}

class _QARTAdminCALScreenState extends State<QARTAdminCALScreen> {
  final Color backgroundColor;
  ...
  final String _adUnitId = Platform.isAndroid
      ? 'ca-app-pub-4857824590253290/6334297889'
      : 'ca-app-pub-4857824590253290/6334297889';
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                const SizedBox(
                    width: 45, child: Icon(Icons.calculate_outlined)),
                Flexible(
  ...
  _QARTAdminCALScreenState({required this.backgroundColor});
              ...
              child: StreamBuilder<QuerySnapshot>(
                stream: _searchController.text.isEmpty
                    ? FirebaseFirestore.instance
                        .collection('QARTnotes')
                        .snapshots()
                    : FirebaseFirestore.instance
                        .collection('QARTnotes')
                        .where('QARTnote_title',
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const QARTAdminEditorScreen()));
        },
