...
import 'package:BetterNotes/subjects/ARTAPP/guest_Eart_reader.dart';
...
class EARTGuestScreen extends StatefulWidget {
  final Color backgroundColor;
  const EARTGuestScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _EARTGuestScreenState createState() =>
      _EARTGuestScreenState(backgroundColor: AppStyle.mainColor);
}

class _EARTGuestScreenState extends State<EARTGuestScreen> {
  final Color backgroundColor;
  ...
  _EARTGuestScreenState({required this.backgroundColor});
