...
import 'package:BetterNotes/subjects/ARTAPP/guest_Aart_reader.dart';
...
class AARTGuestScreen extends StatefulWidget {
  ...
  @override
  _AARTGuestScreenState createState() =>
...
class _AARTGuestScreenState extends State<AARTGuestScreen> {
  ...
  _AARTGuestScreenState({required this.backgroundColor});
