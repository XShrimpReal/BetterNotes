...
import 'package:BetterNotes/subjects/ARTAPP/Eart_card.dart';
import 'package:BetterNotes/subjects/ARTAPP/admin_Aart.dart';
import 'package:BetterNotes/subjects/ARTAPP/admin_Eart_editor.dart';
import 'package:BetterNotes/subjects/ARTAPP/admin_Eart_reader.dart';
...
class EARTAdminCALScreen extends StatefulWidget {
  final Color backgroundColor;
  const EARTAdminCALScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _EARTAdminCALScreenState createState() =>
      _EARTAdminCALScreenState(backgroundColor: AppStyle.mainColor);
}

class _EARTAdminCALScreenState extends State<EARTAdminCALScreen> {
  final Color backgroundColor;
  ...
  _EARTAdminCALScreenState({required this.backgroundColor});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const EARTAdminEditorScreen()));
        },
