...
class EARTAdminReaderScreen extends StatefulWidget {
  EARTAdminReaderScreen(this.doc, {Key? key}) : super(key: key);
  QueryDocumentSnapshot doc;

  @override
  _EARTAdminReaderScreenState createState() => _EARTAdminReaderScreenState();
}
...
class _EARTAdminReaderScreenState extends State<EARTAdminReaderScreen> {
