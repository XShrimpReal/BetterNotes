...
import 'package:BetterNotes/subjects/ARTAPP/Aart_card.dart';
import 'package:BetterNotes/subjects/ARTAPP/admin_Aart_editor.dart';
import 'package:BetterNotes/subjects/ARTAPP/admin_Aart_reader.dart';
...
class AdminARTScreen extends StatefulWidget {
  final Color backgroundColor;
  const AdminARTScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _AdminARTScreenState createState() =>
      _AdminARTScreenState(backgroundColor: AppStyle.mainColor);
}

class _AdminARTScreenState extends State<AdminARTScreen> {
  final Color backgroundColor;
  ...
  _AdminARTScreenState({required this.backgroundColor});
              ...
              child: StreamBuilder<QuerySnapshot>(
                stream: _searchController.text.isEmpty
                    ? FirebaseFirestore.instance
                        .collection('AARTnotes')
                        .snapshots()
                    : FirebaseFirestore.instance
                        .collection('AARTnotes')
                        .where('AARTnote_title',
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const AARTAdminEditorScreen()));
        },
