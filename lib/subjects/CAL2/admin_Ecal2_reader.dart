...
class ECALAdminReaderScreen extends StatefulWidget {
  ECALAdminReaderScreen(this.doc, {Key? key}) : super(key: key);
  QueryDocumentSnapshot doc;

  @override
  _ECALAdminReaderScreenState createState() => _ECALAdminReaderScreenState();
}
...
class _ECALAdminReaderScreenState extends State<ECALAdminReaderScreen> {
