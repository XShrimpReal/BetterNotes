...
class ECALGuestScreen extends StatefulWidget {
  ...
  const ECALGuestScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _ECALGuestScreenState createState() =>
      _ECALGuestScreenState(backgroundColor: AppStyle.mainColor);
}

class _ECALGuestScreenState extends State<ECALGuestScreen> {
  final Color backgroundColor;
  ...
  _ECALGuestScreenState({required this.backgroundColor});
