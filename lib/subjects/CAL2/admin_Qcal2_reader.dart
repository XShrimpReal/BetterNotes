...
class QCALAdminReaderScreen extends StatefulWidget {
  QCALAdminReaderScreen(this.doc, {Key? key}) : super(key: key);
  QueryDocumentSnapshot doc;

  @override
  _QCALAdminReaderScreenState createState() => _QCALAdminReaderScreenState();
}
...
class _QCALAdminReaderScreenState extends State<QCALAdminReaderScreen> {
