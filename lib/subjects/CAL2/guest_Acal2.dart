...
import 'package:BetterNotes/subjects/CAL2/guest_Acal2_reader.dart';
...
class ACALGuestScreen extends StatefulWidget {
  final Color backgroundColor;
  const ACALGuestScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _ACALGuestScreenState createState() =>
      _ACALGuestScreenState(backgroundColor: AppStyle.mainColor);
}

class _ACALGuestScreenState extends State<ACALGuestScreen> {
  final Color backgroundColor;
  ...
  _ACALGuestScreenState({required this.backgroundColor});
