...
import 'package:BetterNotes/subjects/CAL2/admin_Qcal2_editor.dart';
import 'package:BetterNotes/subjects/CAL2/admin_Qcal2_reader.dart';
...
class QCALAdminCALScreen extends StatefulWidget {
  final Color backgroundColor;
  const QCALAdminCALScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _QCALAdminCALScreenState createState() =>
      _QCALAdminCALScreenState(backgroundColor: AppStyle.mainColor);
}

class _QCALAdminCALScreenState extends State<QCALAdminCALScreen> {
  final Color backgroundColor;
  ...
  _QCALAdminCALScreenState({required this.backgroundColor});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const QCALAdminEditorScreen()));
        },
