...
class ACALAdminReaderScreen extends StatefulWidget {
  ACALAdminReaderScreen(this.doc, {Key? key}) : super(key: key);
  QueryDocumentSnapshot doc;

  @override
  _ACALAdminReaderScreenState createState() => _ACALAdminReaderScreenState();
}
...
class _ACALAdminReaderScreenState extends State<ACALAdminReaderScreen> {
