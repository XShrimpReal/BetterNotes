...
import 'package:BetterNotes/subjects/CAL2/admin_Ecal2_reader.dart';
...
class ECALAdminCALScreen extends StatefulWidget {
  final Color backgroundColor;
  const ECALAdminCALScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _ECALAdminCALScreenState createState() =>
      _ECALAdminCALScreenState(backgroundColor: AppStyle.mainColor);
}

class _ECALAdminCALScreenState extends State<ECALAdminCALScreen> {
  final Color backgroundColor;
  ...
  _ECALAdminCALScreenState({required this.backgroundColor});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const ECALAdminEditorScreen()));
        },
