...
import 'package:BetterNotes/subjects/CAL2/admin_Acal2_editor.dart';
import 'package:BetterNotes/subjects/CAL2/admin_Acal2_reader.dart';
...
class AdminCALScreen extends StatefulWidget {
  final Color backgroundColor;
  const AdminCALScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _AdminCALScreenState createState() =>
      _AdminCALScreenState(backgroundColor: AppStyle.mainColor);
}

class _AdminCALScreenState extends State<AdminCALScreen> {
  final Color backgroundColor;
  ...
  _AdminCALScreenState({required this.backgroundColor});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const ACALAdminEditorScreen()));
        },
