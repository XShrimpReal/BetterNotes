...
class QPURGuestReaderScreen extends StatefulWidget {
  QPURGuestReaderScreen(this.doc, {Key? key}) : super(key: key);
  QueryDocumentSnapshot doc;

  @override
  _QPURGuestReaderScreenState createState() => _QPURGuestReaderScreenState();
}
...
class _QPURGuestReaderScreenState extends State<QPURGuestReaderScreen> {
          ...
          appBar: AppBar(
            ...
            title: RichText(
              text: TextSpan(
                ...
                text: widget.doc['QPURnote_title'] as String,
              ),
            ),
            actions: [],
          ),
                ...
                Container(
                  ...
                  child: RichText(
                    text: TextSpan(
                      ...
                      text: widget.doc['QPURnote_content'] as String,
                    ),
                  ),
                ),
              ],
