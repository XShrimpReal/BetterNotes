...
import 'package:BetterNotes/subjects/PHENGR/admin_Aphe_editor.dart';
import 'package:BetterNotes/subjects/PHENGR/admin_Aphe_reader.dart';
...
class AdminPHEScreen extends StatefulWidget {
  final Color backgroundColor;
  const AdminPHEScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _AdminPHEScreenState createState() =>
      _AdminPHEScreenState(backgroundColor: AppStyle.mainColor);
}

class _AdminPHEScreenState extends State<AdminPHEScreen> {
  final Color backgroundColor;
  ...
  _AdminPHEScreenState({required this.backgroundColor});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const APHEAdminEditorScreen()));
        },
