...
class APHEAdminReaderScreen extends StatefulWidget {
  APHEAdminReaderScreen(this.doc, {Key? key}) : super(key: key);
  QueryDocumentSnapshot doc;

  @override
  _APHEAdminReaderScreenState createState() => _APHEAdminReaderScreenState();
}
...
class _APHEAdminReaderScreenState extends State<APHEAdminReaderScreen> {
    ...
    return WillPopScope(
      onWillPop: () async {
        await FirebaseFirestore.instance
          ...
          'AAPHEnote_title': _titleController.text
        });
        return true;
      },
      child: Container(
