...
import 'package:BetterNotes/subjects/PHENGR/Qphe_card.dart';
import 'package:BetterNotes/subjects/PHENGR/admin_Aphe.dart';
import 'package:BetterNotes/subjects/PHENGR/admin_Ephe.dart';
import 'package:BetterNotes/subjects/PHENGR/admin_Qphe_editor.dart';
import 'package:BetterNotes/subjects/PHENGR/admin_Qphe_reader.dart';
...
class QPHEAdminCALScreen extends StatefulWidget {
  final Color backgroundColor;
  const QPHEAdminCALScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _QPHEAdminCALScreenState createState() =>
      _QPHEAdminCALScreenState(backgroundColor: AppStyle.mainColor);
}

class _QPHEAdminCALScreenState extends State<QPHEAdminCALScreen> {
  final Color backgroundColor;
  ...
  _QPHEAdminCALScreenState({required this.backgroundColor});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const QPHEAdminEditorScreen()));
        },
