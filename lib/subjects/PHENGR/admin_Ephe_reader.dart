...
class EPHEAdminReaderScreen extends StatefulWidget {
  EPHEAdminReaderScreen(this.doc, {Key? key}) : super(key: key);
  QueryDocumentSnapshot doc;

  @override
  _EPHEAdminReaderScreenState createState() => _EPHEAdminReaderScreenState();
}
...
class _EPHEAdminReaderScreenState extends State<EPHEAdminReaderScreen> {
