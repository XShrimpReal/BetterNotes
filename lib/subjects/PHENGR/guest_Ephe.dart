...
import 'package:BetterNotes/subjects/PHENGR/guest_Ephe_reader.dart';
...
class EPHEGuestScreen extends StatefulWidget {
  final Color backgroundColor;
  const EPHEGuestScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _EPHEGuestScreenState createState() =>
      _EPHEGuestScreenState(backgroundColor: AppStyle.mainColor);
}

class _EPHEGuestScreenState extends State<EPHEGuestScreen> {
  final Color backgroundColor;
  ...
  _EPHEGuestScreenState({required this.backgroundColor});
