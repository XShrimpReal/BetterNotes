...
import 'package:BetterNotes/subjects/PHENGR/guest_Qphe_reader.dart';
...
class QPHEGuestScreen extends StatefulWidget {
  final Color backgroundColor;
  const QPHEGuestScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _QPHEGuestScreenState createState() =>
      _QPHEGuestScreenState(backgroundColor: AppStyle.mainColor);
}

class _QPHEGuestScreenState extends State<QPHEGuestScreen> {
  final Color backgroundColor;
  ...
  _QPHEGuestScreenState({required this.backgroundColor});
