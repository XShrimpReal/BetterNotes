...
import 'package:BetterNotes/subjects/OBOPRO/guest_Aobo_reader.dart';
...
class AOBOGuestScreen extends StatefulWidget {
  final Color backgroundColor;
  const AOBOGuestScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _AOBOGuestScreenState createState() =>
      _AOBOGuestScreenState(backgroundColor: AppStyle.mainColor);
}

class _AOBOGuestScreenState extends State<AOBOGuestScreen> {
  final Color backgroundColor;
  ...
  _AOBOGuestScreenState({required this.backgroundColor});
