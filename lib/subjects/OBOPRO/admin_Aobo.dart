...
class AdminOBOScreen extends StatefulWidget {
  final Color backgroundColor;
  const AdminOBOScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _AdminOBOScreenState createState() =>
      _AdminOBOScreenState(backgroundColor: AppStyle.mainColor);
}

class _AdminOBOScreenState extends State<AdminOBOScreen> {
  final Color backgroundColor;
  ...
  _AdminOBOScreenState({required this.backgroundColor});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const AOBOAdminEditorScreen()));
        },
