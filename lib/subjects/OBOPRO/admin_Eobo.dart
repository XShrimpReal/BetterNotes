...
import 'package:BetterNotes/subjects/OBOPRO/admin_Eobo_reader.dart';
...
class EOBOAdminCALScreen extends StatefulWidget {
  final Color backgroundColor;
  const EOBOAdminCALScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _EOBOAdminCALScreenState createState() =>
      _EOBOAdminCALScreenState(backgroundColor: AppStyle.mainColor);
}

class _EOBOAdminCALScreenState extends State<EOBOAdminCALScreen> {
  final Color backgroundColor;
  ...
  _EOBOAdminCALScreenState({required this.backgroundColor});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const EOBOAdminEditorScreen()));
        },
