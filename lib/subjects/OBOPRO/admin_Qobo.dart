...
import 'package:BetterNotes/subjects/OBOPRO/admin_Qobo_editor.dart';
import 'package:BetterNotes/subjects/OBOPRO/admin_Qobo_reader.dart';
...
class QOBOAdminCALScreen extends StatefulWidget {
  final Color backgroundColor;
  const QOBOAdminCALScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _QOBOAdminCALScreenState createState() =>
      _QOBOAdminCALScreenState(backgroundColor: AppStyle.mainColor);
}

class _QOBOAdminCALScreenState extends State<QOBOAdminCALScreen> {
  final Color backgroundColor;
  ...
  _QOBOAdminCALScreenState({required this.backgroundColor});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const QOBOAdminEditorScreen()));
        },
