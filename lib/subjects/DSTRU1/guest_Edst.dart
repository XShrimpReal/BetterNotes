...
class EDSTGuestScreen extends StatefulWidget {
  final Color backgroundColor;
  const EDSTGuestScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _EDSTGuestScreenState createState() =>
      _EDSTGuestScreenState(backgroundColor: AppStyle.mainColor);
}

class _EDSTGuestScreenState extends State<EDSTGuestScreen> {
  final Color backgroundColor;
  ...
  _EDSTGuestScreenState({required this.backgroundColor});
