...
import 'package:BetterNotes/subjects/DSTRU1/guest_Qdst_reader.dart';
...
class QDSTGuestScreen extends StatefulWidget {
  final Color backgroundColor;
  const QDSTGuestScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _QDSTGuestScreenState createState() =>
      _QDSTGuestScreenState(backgroundColor: AppStyle.mainColor);
}

class _QDSTGuestScreenState extends State<QDSTGuestScreen> {
  final Color backgroundColor;
  ...
  _QDSTGuestScreenState({required this.backgroundColor});
