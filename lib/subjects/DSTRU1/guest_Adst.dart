...
import 'package:BetterNotes/subjects/DSTRU1/guest_Adst_reader.dart';
...
class ADSTGuestScreen extends StatefulWidget {
  final Color backgroundColor;
  const ADSTGuestScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _ADSTGuestScreenState createState() =>
      _ADSTGuestScreenState(backgroundColor: AppStyle.mainColor);
}

class _ADSTGuestScreenState extends State<ADSTGuestScreen> {
  final Color backgroundColor;
  ...
  _ADSTGuestScreenState({required this.backgroundColor});
