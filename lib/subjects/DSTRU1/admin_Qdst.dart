...
import 'package:BetterNotes/subjects/DSTRU1/Qdst_card.dart';
import 'package:BetterNotes/subjects/DSTRU1/admin_Adst.dart';
import 'package:BetterNotes/subjects/DSTRU1/admin_Edst.dart';
import 'package:BetterNotes/subjects/DSTRU1/admin_Qdst_editor.dart';
import 'package:BetterNotes/subjects/DSTRU1/admin_Qdst_reader.dart';
...
class QDSTAdminCALScreen extends StatefulWidget {
  final Color backgroundColor;
  const QDSTAdminCALScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _QDSTAdminCALScreenState createState() =>
      _QDSTAdminCALScreenState(backgroundColor: AppStyle.mainColor);
}

class _QDSTAdminCALScreenState extends State<QDSTAdminCALScreen> {
  final Color backgroundColor;
  ...
  _QDSTAdminCALScreenState({required this.backgroundColor});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const QDSTAdminEditorScreen()));
        },
