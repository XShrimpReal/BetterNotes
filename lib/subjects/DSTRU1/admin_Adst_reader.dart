...
class ADSTAdminReaderScreen extends StatefulWidget {
  ADSTAdminReaderScreen(this.doc, {Key? key}) : super(key: key);
  QueryDocumentSnapshot doc;

  @override
  _ADSTAdminReaderScreenState createState() => _ADSTAdminReaderScreenState();
}
...
class _ADSTAdminReaderScreenState extends State<ADSTAdminReaderScreen> {
