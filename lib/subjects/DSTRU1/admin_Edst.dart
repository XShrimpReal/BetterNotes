...
import 'package:BetterNotes/subjects/DSTRU1/admin_Edst_editor.dart';
import 'package:BetterNotes/subjects/DSTRU1/admin_Edst_reader.dart';
...
class EDSTAdminCALScreen extends StatefulWidget {
  final Color backgroundColor;
  const EDSTAdminCALScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _EDSTAdminCALScreenState createState() =>
      _EDSTAdminCALScreenState(backgroundColor: AppStyle.mainColor);
}

class _EDSTAdminCALScreenState extends State<EDSTAdminCALScreen> {
  final Color backgroundColor;
  ...
  _EDSTAdminCALScreenState({required this.backgroundColor});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const EDSTAdminEditorScreen()));
        },
