...
import 'package:BetterNotes/subjects/ENGIDA/guest_Eeng_reader.dart';
...
class EENGGuestScreen extends StatefulWidget {
  final Color backgroundColor;
  const EENGGuestScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _EENGGuestScreenState createState() =>
      _EENGGuestScreenState(backgroundColor: AppStyle.mainColor);
}

class _EENGGuestScreenState extends State<EENGGuestScreen> {
  final Color backgroundColor;
  ...
  _EENGGuestScreenState({required this.backgroundColor});
