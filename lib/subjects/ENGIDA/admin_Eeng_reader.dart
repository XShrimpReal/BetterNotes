...
class EENGAdminReaderScreen extends StatefulWidget {
  EENGAdminReaderScreen(this.doc, {Key? key}) : super(key: key);
  QueryDocumentSnapshot doc;

  @override
  _EENGAdminReaderScreenState createState() => _EENGAdminReaderScreenState();
}
...
class _EENGAdminReaderScreenState extends State<EENGAdminReaderScreen> {
