...
import 'package:BetterNotes/subjects/ENGIDA/guest_Qeng_reader.dart';
...
class QENGGuestScreen extends StatefulWidget {
  final Color backgroundColor;
  const QENGGuestScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _QENGGuestScreenState createState() =>
      _QENGGuestScreenState(backgroundColor: AppStyle.mainColor);
}

class _QENGGuestScreenState extends State<QENGGuestScreen> {
  final Color backgroundColor;
  ...
  _QENGGuestScreenState({required this.backgroundColor});
