...
import 'package:BetterNotes/subjects/ENGIDA/admin_Eeng_editor.dart';
import 'package:BetterNotes/subjects/ENGIDA/admin_Eeng_reader.dart';
...
class EENGAdminCALScreen extends StatefulWidget {
  final Color backgroundColor;
  const EENGAdminCALScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _EENGAdminCALScreenState createState() =>
      _EENGAdminCALScreenState(backgroundColor: AppStyle.mainColor);
}

class _EENGAdminCALScreenState extends State<EENGAdminCALScreen> {
  final Color backgroundColor;
  ...
  _EENGAdminCALScreenState({required this.backgroundColor});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const EENGAdminEditorScreen()));
        },
