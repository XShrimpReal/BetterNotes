...
import 'package:BetterNotes/subjects/ENGIDA/guest_Aeng_reader.dart';
...
class AENGGuestScreen extends StatefulWidget {
  final Color backgroundColor;
  const AENGGuestScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _AENGGuestScreenState createState() =>
      _AENGGuestScreenState(backgroundColor: AppStyle.mainColor);
}

class _AENGGuestScreenState extends State<AENGGuestScreen> {
  final Color backgroundColor;
  ...
  _AENGGuestScreenState({required this.backgroundColor});
