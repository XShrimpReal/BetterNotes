...
import 'package:BetterNotes/subjects/ENGIDA/Qeng_card.dart';
import 'package:BetterNotes/subjects/ENGIDA/admin_Aeng.dart';
import 'package:BetterNotes/subjects/ENGIDA/admin_Eeng.dart';
import 'package:BetterNotes/subjects/ENGIDA/admin_Qeng_editor.dart';
import 'package:BetterNotes/subjects/ENGIDA/admin_Qeng_reader.dart';
...
class QENGAdminCALScreen extends StatefulWidget {
  final Color backgroundColor;
  const QENGAdminCALScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _QENGAdminCALScreenState createState() =>
      _QENGAdminCALScreenState(backgroundColor: AppStyle.mainColor);
}

class _QENGAdminCALScreenState extends State<QENGAdminCALScreen> {
  final Color backgroundColor;
  ...
  _QENGAdminCALScreenState({required this.backgroundColor});
              ...
              child: StreamBuilder<QuerySnapshot>(
                stream: _searchController.text.isEmpty
                    ? FirebaseFirestore.instance
                        .collection('QENGnotes')
                        .snapshots()
                    : FirebaseFirestore.instance
                        .collection('QENGnotes')
                        .where('QENGnote_title',
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const QENGAdminEditorScreen()));
        },
