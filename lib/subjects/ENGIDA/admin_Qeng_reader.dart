...
class QENGAdminReaderScreen extends StatefulWidget {
  QENGAdminReaderScreen(this.doc, {Key? key}) : super(key: key);
  QueryDocumentSnapshot doc;

  @override
  _QENGAdminReaderScreenState createState() => _QENGAdminReaderScreenState();
}
...
class _QENGAdminReaderScreenState extends State<QENGAdminReaderScreen> {
