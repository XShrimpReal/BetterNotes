...
import 'package:BetterNotes/subjects/ENGIDA/Aeng_card.dart';
import 'package:BetterNotes/subjects/ENGIDA/admin_Aeng_editor.dart';
import 'package:BetterNotes/subjects/ENGIDA/admin_Aeng_reader.dart';
...
class AdminENGScreen extends StatefulWidget {
  final Color backgroundColor;
  const AdminENGScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _AdminENGScreenState createState() =>
      _AdminENGScreenState(backgroundColor: AppStyle.mainColor);
}

class _AdminENGScreenState extends State<AdminENGScreen> {
  final Color backgroundColor;
  ...
  _AdminENGScreenState({required this.backgroundColor});
              ...
              child: StreamBuilder<QuerySnapshot>(
                stream: _searchController.text.isEmpty
                    ? FirebaseFirestore.instance
                        .collection('AENGnotes')
                        .snapshots()
                    : FirebaseFirestore.instance
                        .collection('AENGnotes')
                        .where('AENGnote_title',
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const AENGAdminEditorScreen()));
        },
