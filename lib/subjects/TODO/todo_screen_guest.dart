...
class TODOGuestScreen extends StatefulWidget {
  ...
  const TODOGuestScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _TODOGuestScreenState createState() =>
      _TODOGuestScreenState(backgroundColor: AppStyle.mainColor);
}

class _TODOGuestScreenState extends State<TODOGuestScreen> {
  final Color backgroundColor;
  ...
  _TODOGuestScreenState({required this.backgroundColor});
