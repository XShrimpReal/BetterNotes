...
import 'package:BetterNotes/subjects/CHENGR/Ache_card.dart';
import 'package:BetterNotes/subjects/CHENGR/admin_Ache_editor.dart';
import 'package:BetterNotes/subjects/CHENGR/admin_Ache_reader.dart';
...
class AdminCHEScreen extends StatefulWidget {
  final Color backgroundColor;
  const AdminCHEScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _AdminCHEScreenState createState() =>
      _AdminCHEScreenState(backgroundColor: AppStyle.mainColor);
}

class _AdminCHEScreenState extends State<AdminCHEScreen> {
  final Color backgroundColor;
            ...
            Padding(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      const SizedBox(
                          width: 45, child: Icon(Icons.science_outlined)),
                      Flexible(
  ...
  _AdminCHEScreenState({required this.backgroundColor});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const ACHEAdminEditorScreen()));
        },
