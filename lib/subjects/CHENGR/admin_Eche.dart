...
import 'package:BetterNotes/subjects/CHENGR/admin_Eche_editor.dart';
import 'package:BetterNotes/subjects/CHENGR/admin_Eche_reader.dart';
...
class ECHEAdminCALScreen extends StatefulWidget {
  final Color backgroundColor;
  const ECHEAdminCALScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _ECHEAdminCALScreenState createState() =>
      _ECHEAdminCALScreenState(backgroundColor: AppStyle.mainColor);
}

class _ECHEAdminCALScreenState extends State<ECHEAdminCALScreen> {
  final Color backgroundColor;
  ...
  _ECHEAdminCALScreenState({required this.backgroundColor});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const ECHEAdminEditorScreen()));
        },
