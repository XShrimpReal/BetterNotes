...
import 'package:BetterNotes/subjects/CHENGR/guest_Ache_reader.dart';
...
class ACHEGuestScreen extends StatefulWidget {
  final Color backgroundColor;
  const ACHEGuestScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _ACHEGuestScreenState createState() =>
      _ACHEGuestScreenState(backgroundColor: AppStyle.mainColor);
}

class _ACHEGuestScreenState extends State<ACHEGuestScreen> {
  final Color backgroundColor;
  ...
  _ACHEGuestScreenState({required this.backgroundColor});
