...
import 'package:BetterNotes/subjects/CHENGR/guest_Qche_reader.dart';
...
class QCHEGuestScreen extends StatefulWidget {
  final Color backgroundColor;
  const QCHEGuestScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _QCHEGuestScreenState createState() =>
      _QCHEGuestScreenState(backgroundColor: AppStyle.mainColor);
}

class _QCHEGuestScreenState extends State<QCHEGuestScreen> {
  final Color backgroundColor;
  ...
  _QCHEGuestScreenState({required this.backgroundColor});
