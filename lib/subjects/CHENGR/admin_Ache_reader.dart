...
class ACHEAdminReaderScreen extends StatefulWidget {
  ACHEAdminReaderScreen(this.doc, {Key? key}) : super(key: key);
  QueryDocumentSnapshot doc;

  @override
  _ACHEAdminReaderScreenState createState() => _ACHEAdminReaderScreenState();
}
...
class _ACHEAdminReaderScreenState extends State<ACHEAdminReaderScreen> {
