...
class ECHEGuestReaderScreen extends StatefulWidget {
  ECHEGuestReaderScreen(this.doc, {Key? key}) : super(key: key);
  QueryDocumentSnapshot doc;

  @override
  _ECHEGuestReaderScreenState createState() => _ECHEGuestReaderScreenState();
}
...
class _ECHEGuestReaderScreenState extends State<ECHEGuestReaderScreen> {
          ...
          appBar: AppBar(
            ...
            title: RichText(
              text: TextSpan(
                ...
                text: widget.doc['ECHEnote_title'] as String,
              ),
            ),
            actions: [],
          ),
                ...
                Container(
                  ...
                  child: RichText(
                    text: TextSpan(
                      ...
                      text: widget.doc['ECHEnote_content'] as String,
                    ),
                  ),
                ),
              ],
