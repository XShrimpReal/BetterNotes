...
class AdminReaderScreen extends StatefulWidget {
  AdminReaderScreen(this.doc, {Key? key}) : super(key: key);
  QueryDocumentSnapshot doc;

  @override
  _AdminReaderScreenState createState() => _AdminReaderScreenState();
}
...
class _AdminReaderScreenState extends State<AdminReaderScreen> {
