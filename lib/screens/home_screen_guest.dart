...
import 'package:BetterNotes/screens/guest_reader.dart';
...
class GuestScreen extends StatefulWidget {
  ...
  const GuestScreen({Key? key, required this.backgroundColor})
      : super(key: key);

  @override
  _GuestScreenState createState() =>
      _GuestScreenState(backgroundColor: AppStyle.mainColor);
}
...
class _GuestScreenState extends State<GuestScreen> {
  ...
  _GuestScreenState({required this.backgroundColor});
